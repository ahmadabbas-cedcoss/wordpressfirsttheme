...
function xyz_scripts_bootstrap() {
	wp_enqueue_script( 'xyz-jquery', get_template_directory_uri() . '/js/jquery.min.js', _S_VERSION, true );
	wp_enqueue_script( 'xyz-bootstrapbundle', get_template_directory_uri() . '/js/bootstrap.bundle.min.js', _S_VERSION, true );
}
add_action( 'wp_enqueue_scripts', 'xyz_scripts_bootstrap' );
...
function xyz_scripts() {
	...
	wp_enqueue_script( 'xyz-accordions', get_template_directory_uri() . '/js/accordions.js', _S_VERSION, true );	
	wp_enqueue_script( 'xyz-custom', get_template_directory_uri() . '/js/custom.js', _S_VERSION, true );
	wp_enqueue_script( 'xyz-isotope', get_template_directory_uri() . '/js/isotope.js', _S_VERSION, true );
	wp_enqueue_script( 'xyz-owl', get_template_directory_uri() . '/js/owl.js', _S_VERSION, true );
	wp_enqueue_script( 'xyz-slick', get_template_directory_uri() . '/js/slick.js', _S_VERSION, true );


	wp_style_add_data( 'xyz-style', 'rtl', 'replace' );

	wp_enqueue_script( 'xyz-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
...
function addMyScript() {
    wp_enqueue_style('theme',get_bloginfo('template_directory').'/style.less', array('blueprint'), '', 'screen, projection');
}
